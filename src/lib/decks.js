...
export const DEFAULT_DECKS = [
  {
    ...
    cardTypes: [
      ...
      },
      {
        ...
        color: '#eab308',
        quantity: 2,
        sides: { top: 5, right: 3, bottom: 2, left: 3 },
      },
    ],
  },
  {
    ...
    cardTypes: [
      ...
      },
      {
        ...
        color: '#38bdf8',
        quantity: 5,
        sides: { top: 3, right: 2, bottom: 1, left: 2 },
      },
      {
        id: 'pelican',
        name: 'Pelican',
        ...
        color: '#f97316',
        quantity: 2,
        sides: { top: 4, right: 4, bottom: 2, left: 4 },
      },
      {
        id: 'cockatoo',
        name: 'Cockatoo',
        ...
        color: '#facc15',
        quantity: 2,
        sides: { top: 5, right: 2, bottom: 1, left: 2 },
      },
    ],
  },
  {
    ...
    cardTypes: [
      ...
      },
      {
        ...
        color: '#0891b2',
        quantity: 4,
        sides: { top: 3, right: 3, bottom: 1, left: 2 },
      },
      {
        id: 'magpie',
        name: 'Magpie',
        ...
        color: '#0f172a',
        quantity: 2,
        sides: { top: 4, right: 2, bottom: 1, left: 2 },
      },
      {
        id: 'swan',
        name: 'Swan',
